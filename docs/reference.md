...
In addition, if you have used spikeins in your experiment, you can define them as a gzipped fasta file in workflow level variable `long_read_rna_pipeline.spikeins`.
