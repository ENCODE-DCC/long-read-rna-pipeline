...
RUN chmod 755 TALON/src/talon/initialize_talon_database.py TALON/src/talon/talon.py TALON/src/talon/post/create_abundance_file_from_database.py TALON/src/talon/post/create_GTF_from_database.py /software/TALON/src/talon/post/filter_talon_transcripts.py
